...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-1 flex-col justify-end bg-[linear-gradient(180deg,#F8FAFC_0%,#EEF6FF_100%)] pb-[60px] pt-10 dark:bg-[linear-gradient(180deg,#0F172A_0%,#020617_100%)] sm:pt-14">
