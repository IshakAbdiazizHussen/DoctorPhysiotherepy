              ...
              <div className="relative z-10 flex h-full flex-col">
                ...
                >
                  <span className="flex items-center gap-4">
                    ...
                    <span className="max-w-[340px] text-[16px] font-normal leading-[1.45] text-[#334155] dark:text-[#E2E8F0]">
            ...
            <div className="mt-6 grid gap-4 rounded-[24px] bg-[#FAFCFF] p-4 dark:bg-[#0F172A] sm:grid-cols-3 sm:gap-0 sm:p-0">
              {features.map(({ icon: Icon, label }, index) => (
                ...
                >
                  ...
                  <span className="text-[16px] font-normal leading-[1.45] text-[#334155] dark:text-[#E2E8F0]">
                    {label}
                  </span>
                </div>
              ))}
