      ...
      <Container className="max-w-[1600px] px-8 sm:px-8 xl:px-8">
        <div className="grid gap-8 lg:grid-cols-[48%_52%]">
          <article className="group relative overflow-hidden rounded-[32px] border border-[#EEF2F7] bg-[linear-gradient(180deg,#F7FBFA_0%,#EEF8F6_100%)] p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)] transition duration-300 hover:-translate-y-1 dark:border-[#1E293B] dark:bg-[linear-gradient(180deg,#0F172A_0%,#111827_100%)] dark:shadow-[0_24px_60px_-24px_rgba(2,6,23,0.82)] sm:p-10 xl:p-10">
            ...
            <div className="pointer-events-none absolute bottom-12 left-[38%] h-40 w-40 rounded-full bg-[rgba(96,165,250,0.07)] blur-3xl dark:bg-[rgba(96,165,250,0.08)]" />
            ...
            <div className="grid items-center gap-8 xl:grid-cols-[50%_50%]">
              <div className="relative z-10 flex h-full flex-col">
                <span className="inline-flex w-fit items-center gap-3 rounded-full bg-white px-5 py-3 text-[14px] font-bold uppercase tracking-[0.16em] text-[#0F9F97] shadow-[0_18px_38px_-28px_rgba(15,118,110,0.18)] dark:bg-[#111827] dark:text-[#34D399]">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[rgba(20,184,166,0.1)] text-[#0F9F97] dark:bg-[rgba(52,211,153,0.12)] dark:text-[#34D399]">
                    <ShieldCheck className="h-5 w-5" />
                  </span>
                  Better Recovery
                </span>

                <h2 className="mt-8 max-w-[500px] text-[42px] font-extrabold leading-[0.95] tracking-[-0.04em] text-[#0F172A] dark:text-[#F8FAFC] sm:text-[54px] xl:text-[72px]">
                  We help you move <span className="text-[#10B981]">better</span> and live{" "}
                  <span className="text-[#10B981]">better</span>.
                </h2>

                <div className="mt-7 h-[4px] w-14 rounded-full bg-[#14B8A6]" />

                <p className="mt-7 max-w-[500px] text-[18px] font-normal leading-[1.8] text-[#64748B] dark:text-[#94A3B8]">
                ...
                <a
                  href="#appointment"
                  className="mt-8 inline-flex h-[90px] w-full max-w-[460px] items-center justify-between rounded-[20px] bg-white px-7 text-left shadow-[0_20px_45px_rgba(15,23,42,0.08)] transition duration-300 hover:shadow-[0_24px_50px_rgba(15,23,42,0.1)] dark:bg-[#111827] dark:shadow-[0_20px_45px_-20px_rgba(2,6,23,0.82)]"
                >
                  <span className="flex items-center gap-4">
                    <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[rgba(20,184,166,0.1)] text-[#0F9F97] dark:bg-[rgba(52,211,153,0.12)] dark:text-[#34D399]">
                      <ShieldCheck className="h-6 w-6" />
                    </span>
                    <span className="max-w-[280px] text-[18px] font-semibold leading-[1.35] text-[#0F172A] dark:text-[#F8FAFC]">
              ...
              <div className="relative z-10 flex justify-center xl:justify-end">
                ...
                <div className="relative w-full max-w-[300px] overflow-hidden rounded-[24px] shadow-[0_22px_48px_rgba(15,23,42,0.12)] dark:shadow-[0_22px_48px_-20px_rgba(2,6,23,0.82)]">
                  <Image
                    src="/images/female.jpg"
                    alt="Doctor smiling during a patient consultation"
                    width={720}
                    height={980}
                    className="h-[360px] w-full object-cover object-top sm:h-[390px] xl:h-[420px]"
                  />
                </div>
              </div>
            </div>
